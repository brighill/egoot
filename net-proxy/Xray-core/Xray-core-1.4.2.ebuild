...
SRC_URI="
	https://github.com/XTLS/Xray-core/archive/$MY_PV.tar.gz -> $P.tar.gz
    ${EGO_SUM_SRC_URI}
"
...
src_install() {
	...
	doins "${FILESDIR}/geoip.dat" "${FILESDIR}/geosite.dat"

	insinto /etc/xray
	doins "${FILESDIR}/config.json"

	fperms 0755 /usr/bin/xray /usr/share/xray/{geoip.dat,geosite.dat}
