# Copyrighet_globalet_globals 1999-2020 Gentoo Authors
...
SRC_URI="
	https://github.com/fatedier/frp/archive/${MY_PV}.tar.gz -> $P.tar.gz 
	${EGO_SUM_SRC_URI}
"
...
src_install() {
	...
	insinto /etc/frp
	doins conf/frpc.ini 
	doins conf/frpc_full.ini 
	doins conf/frps.ini 
	doins conf/frps_full.ini 

	fperms 0755 /usr/lib/frp/{frpc,frps}
	
	dosym  /usr/lib/frp/frpc /usr/bin/frpc
	dosym  /usr/lib/frp/frpc /usr/bin/frps 

	systemd_dounit conf/systemd/frpc.service
	systemd_dounit conf/systemd/frps.service
}
