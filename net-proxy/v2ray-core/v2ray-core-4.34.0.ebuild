...
SRC_URI="
	https://github.com/v2fly/v2ray-core/archive/$MY_PV.tar.gz -> $P.tar.gz 
    ${EGO_SUM_SRC_URI}
"
...
src_install() {
	...
	doins release/config/geoip.dat release/config/geosite.dat 

	insinto /etc/v2ray
	doins release/config/*.json

	fperms 0755 /usr/bin/{v2ray,v2ctl} /usr/share/v2ray/{geoip.dat,geosite.dat}
